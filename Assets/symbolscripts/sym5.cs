...
public class sym5 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (myObject.GetComponent<keypadimagecontroller>().image1 == 5)
        {
            gamesymbol1.SetActive(true);

        }
        else if (myObject.GetComponent<keypadimagecontroller>().image2 == 5)
        {
            gamesymbol1.SetActive(true);
            m_RectTransform.anchoredPosition = new Vector2(200, 150);
        }
        else if (myObject.GetComponent<keypadimagecontroller>().image3 == 5)
        {
            gamesymbol1.SetActive(true);
            m_RectTransform.anchoredPosition = new Vector2(-235, -150);
        }
        else if (myObject.GetComponent<keypadimagecontroller>().image4 == 5)
        {
            gamesymbol1.SetActive(true);
