...
{
    public class thirdwire4 : VRTK_InteractableObject
    {
        ...
        protected override void Update()
        {
            ...
            {
                if (myObject.GetComponent<firstwire4>().randomRed1 == 3 || myObject.GetComponent<firstwire4>().randomRed2 == 3)
                {
                    choose4wires1 = 0;
            ...
            {
                if (myObject.GetComponent<firstwire4>().blue == 3)
                {
                    choose4wires1 = 4;
                    Color c = colors[choose4wires1];
            ...
            {
                if (myObject.GetComponent<firstwire4>().randomYellow1 == 3 || myObject.GetComponent<firstwire4>().randomYellow2 == 3)
                {
                    choose4wires1 = 1;
                    Color c = colors[choose4wires1];
                ...
                else if (myObject.GetComponent<firstwire4>().redNum == 0 && (myObject.GetComponent<firstwire4>().randomYellow1 == 4 || myObject.GetComponent<firstwire4>().randomYellow2 == 4))
                {
                    choose4wires1 = 0;
                    Color c = colors[choose4wires1];
            ...
            {
                if (myObject.GetComponent<firstwire4>().redNum >= 1)
                {
                    if (myObject.GetComponent<firstwire4>().yellowNum >= 1)
                    {
                ...
                else if (myObject.GetComponent<firstwire4>().yellowNum >= 1)
                {
                    choose4wires1 = Random.Range(0, 4);
                    if (choose4wires1 == 1)
                    {
        ...
        private void OnMouseDown()
        {
            ...
            {
                if (fourthwire4.choose4wires1 != 0 && choose4wires1 == 0)
                {
        ...
        public override void StartUsing(VRTK_InteractUse currentUsingObject = null)
        {
            ...
            marker.Write("third wire (4 wires)" + " cut at ", Time.time);
            if (myObject.GetComponent<firstwire4>().scenario4wires == 1)
            {
                if (fourthwire4.choose4wires1 != 0 && choose4wires1 == 0)
                {
