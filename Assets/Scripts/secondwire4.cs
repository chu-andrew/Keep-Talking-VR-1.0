...
{
    public class secondwire4 : VRTK_InteractableObject
    {
        ...
        protected override void Update()
        {
            ...
            {
                if (myObject.GetComponent<firstwire4>().randomRed1 == 2 || myObject.GetComponent<firstwire4>().randomRed2 == 2)
                {
                    choose4wires1 = 0;
            ...
            {
                if (myObject.GetComponent<firstwire4>().blue == 2)
                {
                    choose4wires1 = 4;
                    Color c = colors[choose4wires1];
            ...
            {
                if (myObject.GetComponent<firstwire4>().randomYellow1 == 2 || myObject.GetComponent<firstwire4>().randomYellow2 == 2)
                {
                    choose4wires1 = 1;
                    Color c = colors[choose4wires1];
