...
public class simonsaysinstantiate : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (stop8 == 0 && randomizeModules.chooseModule9 == 6)
        {
            Quaternion rotation = Quaternion.Euler(0, -90, 0);
